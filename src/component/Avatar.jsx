    ...
    <>
      {props.isLoggedIn ?
        ...
        <div className="hs-dropdown relative inline-flex">
          <button id="hs-dropdown-custom-trigger" type="button" className="hs-dropdown-toggle py-1 pl-1 pr-3 inline-flex justify-center items-center gap-2 rounded-full border-2 font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm" >
            <img className="w-8 h-auto rounded-full" src={AvatarUrl} alt="name"></img>
            <span className="text-gray-600 font-medium truncate max-w-[7.5rem] ">{props.username}</span>
        ...
        <div className="relative inline-flex">
          <button type="button" className="py-3 px-3 inline-flex justify-center items-center gap-2 rounded-full border-2 font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none border-blue-600 focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm" >
