    ...
    <>
      <div id="hs-basic-modal" class="flex z-10 absolute bottom-28 left-4 flex-col bg-white border shadow-sm rounded-xl">
        <div class="flex justify-between items-center py-3 px-4 border-b ">
          ...
          <button type="button" class="hs-dropdown-toggle inline-flex flex-shrink-0 justify-center items-center h-8 w-8 rounded-md text-gray-500 hover:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white transition-all text-sm " data-hs-modal="#hs-basic-modal">
        ...
        <div class="p-4 overflow-y-auto">
          <p class="mt-1 text-gray-800 ">
            Copy this link and send it to the people that you want to <br></br>
            call with. Make sure that you save it so that<br></br>
